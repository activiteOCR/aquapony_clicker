...
import { bear, coin, highVoltage, rocket, trophy, pony } from "./images";
      ...
      <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
        ...
        <div className="fixed bottom-0 left-0 w-full px-4 pb-4 z-10">
          <div className="w-full flex justify-between gap-2">
            ...
            <div className="flex-grow flex items-center max-w-60 text-sm">
              <div className="w-full bg-[#444] py-4 rounded-2xl flex justify-around">
                <button className="flex flex-col items-center gap-1">
                  <img src={bear} width={24} height={24} alt="Bear" />
                  <span>Frens</span>
                </button>
                <div className="h-[48px] w-[2px] bg-[#555]"></div>
                <button className="flex flex-col items-center gap-1">
          ...
          <div className="w-full bg-[#444] rounded-full mt-4">
            <div
              className="bg-gradient-to-r from-pink-500 to-blue-500 h-4 rounded-full"
        ...
        <div className="flex-grow flex items-center justify-center">
          <div className="relative mt-4" onClick={handleClick}>
            <img src={pony} width={256} height={256} alt="notcoin" />
            {clicks.map((click) => (
              <div
                key={click.id}
